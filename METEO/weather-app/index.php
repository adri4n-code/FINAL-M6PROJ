...
<body class="text-bg-dark ">
    <div class="main-container container-fluid p-3 d-flex flex-column justify-content-between">
        <header class="mb-2 d-flex flex-row align-items-center justify-content-between w-100 px-5 flex-wrap">
            ...
            <div class="d-flex">
                <input id="searchLocation" class="search-input form-control me-2 bg-white bg-gradient" type="search"
                ...
                <div class="modal-content bg-blue">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <br>
                            <br>
                            <div type="button" class="btn-google button-login btn">
                                <?php
                                if($login_button == '') {
                                    ...
                                    echo '<div align="center"><div class="btn-google button-login">' . $login_button . '</div></div>';
                                }
                                ?>
                                </div>
        ...
        <footer class="w-100 mt-5 text-white-50 d-flex flex-columns justify-content-around">
            <span class="text-white">ETP XAVIER CFGS DAW M6-M7 2023/2024</span>
